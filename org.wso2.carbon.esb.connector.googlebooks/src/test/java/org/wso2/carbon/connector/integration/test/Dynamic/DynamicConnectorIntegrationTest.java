...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.Dynamic;
 ...
 */
public class DynamicConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "Dynamic test case")
